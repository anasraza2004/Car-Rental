...
public class CustomerSqlQueryConstant {
    ...
    public final static String UPDATE_BY_ID = "update customer set customer_name = ?, phone_number = ?, cnic=?, address=?, reference_no=?, status=? where id = ?";
    public final static String DELETE = "delete from customer where id = ?";
    public final static String SOFT_DELETE = "update customer set status = 'Inactive' where id = ?";
